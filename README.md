...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiomqtt-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10476&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiomqtt-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiomqtt` can be installed with:

```
conda install aiomqtt
```

It is possible to list all of the versions of `aiomqtt` available on your platform with:
